...
with st.expander("Explicación del Programa"):
    ...
    with col1:
        st.write("**Selecciona el archivo:** Cada archivo contiene información diferente")
    with col2:
        st.write("**Analiza los datos:** En la tabla de los datos, chcecar los nombres de las columnas para hacer la pregunta")
    with col3:
        st.write("**Realiza la pregunta:** Como se explico anteriormente.")
